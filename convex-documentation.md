...
- [Create project](/management-api/create-project.md): Create a new project on a team, optionally provisioning a dev or prod
...
- [Get project by ID](/management-api/get-project-by-id.md): Get a project by its ID.
- [Get project by slug](/management-api/get-project-by-slug.md): Get a project by its slug.
...
- [List deployment classes](/management-api/list-deployment-classes.md): Lists the available deployment classes for a team.
- [List deployment regions](/management-api/list-deployment-regions.md): Lists the available deployment regions for a team.
...
- [List team members](/management-api/list-team-members.md): List the members of the given team.
- [Get deployment](/management-api/platform-get-deployment.md): Get details about a cloud deployment.
